  ...
  menus.add(PopupMenuItem(
    ...
    child: InkWell(
      onTap: () async {
        ...
        await canLaunch(anySheet.config.sheetParams['fileIdUrl:'])
            ? await launch(anySheet.config.sheetParams['fileIdUrl:'])
            : throw 'Could not launch ${anySheet.config.sheetParams['fileIdUrl:']}';
      },

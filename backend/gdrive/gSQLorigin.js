...
//thanks to YionoFr
//https://raw.githubusercontent.com/YionoFr/GoogleScriptSQL/master/code.js
//https://docs.yiono.fr/#getting_started
...
var gSQL = function() {
  ...
  function aCompareToB(arg1, arg2, arg3, data, bool, Meth) {
    ...
    switch (arg2) {
        case 'EQ': 
            logi('-------------------------EQ')
            map.forEach(function(elt, index) {if(index > 0) {if(elt == arg3) {match.push(index); logi(index + ': ' + elt); }}});
            break;
